...
export const EXCEL_HEADER_MAP = {
  'Cartão QSA': 'anexo_cartao_qsa',
  'Cartao QSA': 'anexo_cartao_qsa',
  CNPJ: 'cnpj',
  ...
  'Responsável pela ECF': 'responsavel_ecf',
...
export const DEFAULT_LISTS = {
  ...
  status_retorno_cliente: ['Aguardando retorno', 'Retorno recebido', 'Sem retorno', 'Concluído'],
